...
export default function CTA() {
  ...
  return (
    <section ref={sectionRef} id="download" className="cta-section">
      <div className="cta-inner" style={{ opacity: 0 }}>
        ...
        <div className="cta-content">
          ...
          <div className="cta-buttons">
            <a href="https://apps.apple.com/app/id6755610772" className="cta-btn-primary">
            ...
            <a href="https://play.google.com/store/apps/details?id=com.pera.vimble" className="cta-btn-primary">
              <svg width="20" height="20" viewBox="0 0 24 24" fill="currentColor">
